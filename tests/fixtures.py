...
def sample_transaction(
    *,
    ...
    counterparty_account: str = "123456789",
    counterparty_bank_code: str = "2010",
    ...
    return {
        ...
        "column2": {"value": counterparty_account, "name": "Protiucet", "id": 2},
        "column3": {"value": counterparty_bank_code, "name": "Kod banky", "id": 3},
